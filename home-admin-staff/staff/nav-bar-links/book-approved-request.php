...
if(isset($_POST["confirm_recieved"])){
  ...
  if($return_due_date){
    $query = "UPDATE borrow_request_instructor SET request_status='BORROWED', return_due_date='$return_due_date', staff_borrow=$staff_number WHERE transaction_id=$transaction_id";
